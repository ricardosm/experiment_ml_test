...
def _setup(request):
    ...
    path = 'C:/Users/Ricardo/Downloads/00_mestrado/dissertation_project/examples/iris/test_iris_float/test_iris_dtc_experiment_data.json'
    yield path
...
class TestIrisProperty:
    ...
    @given(st.sampled_from([4.9, 5.6, 5.7, 5.8, 6.0, 6.1, 6.3, 6.5, 6.9, 7.7]),
           ...
           st.floats(min_value=4.850001, max_value=6.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.650001, max_value=2.5, exclude_min=True, allow_nan=False))
    ...
    @given(st.sampled_from([4.9, 5.2, 5.4, 5.9, 6.1, 6.3, 6.4, 6.5, 6.7, 6.8]),
           st.floats(min_value=3.100001, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=2.45, max_value=4.85, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.650001, max_value=2.5, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([5.6, 5.9, 6.0, 6.1, 6.2, 6.3, 6.7, 6.9, 7.2, 7.9]),
           st.floats(min_value=2.0, max_value=3.1, allow_nan=False),
           st.floats(min_value=2.45, max_value=4.85, exclude_min=True, allow_nan=False),
           st.floats(min_value=1.650001, max_value=2.5, exclude_min=True, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=6.150001, max_value=7.9, exclude_min=True, allow_nan=False),
           st.sampled_from([2.2, 2.5, 2.6, 2.8, 2.9, 3.1, 3.2, 3.3, 3.4, 3.8]),
           st.floats(min_value=4.950001, max_value=6.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.1, max_value=1.65, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=4.3, max_value=6.15, allow_nan=False),
           st.floats(min_value=2.450001, max_value=4.4, exclude_min=True, allow_nan=False),
           st.floats(min_value=4.950001, max_value=6.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.1, max_value=1.65, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.floats(min_value=4.3, max_value=6.15, allow_nan=False),
           st.floats(min_value=2.0, max_value=2.45, allow_nan=False),
           st.floats(min_value=4.950001, max_value=6.9, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.1, max_value=1.65, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([4.9, 5.0, 5.2, 5.4, 5.6, 6.2, 6.4, 6.8, 6.9, 7.0]),
           ...
           st.floats(min_value=2.45, max_value=4.95, exclude_min=True, allow_nan=False),
           st.floats(min_value=0.1, max_value=1.65, allow_nan=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([4.3, 4.4, 4.5, 4.6, 4.7, 4.9, 5.0, 5.3, 5.5, 5.7]),
           ...
           st.floats(min_value=1.0, max_value=2.449999, allow_nan=False),
