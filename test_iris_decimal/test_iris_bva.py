...
def _setup(request):
    ...
    path = 'C:/Users/Ricardo/Downloads/00_mestrado/dissertation_project/examples/iris/test_iris_decimal/test_iris_bva_experiment_data.json'
    yield path
...
class TestIrisProperty:
    ...
    @given(st.sampled_from([4.9, 5.6, 5.7, 5.8, 6.0, 6.1, 6.3, 6.5, 6.9, 7.7]),
           ...
           st.decimals(min_value=4.86, max_value=5.26, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=1.66, max_value=1.82, places=1, allow_nan=False, allow_infinity=False))
    ...
    @given(st.sampled_from([4.9, 5.2, 5.4, 5.9, 6.1, 6.3, 6.4, 6.5, 6.7, 6.8]),
           st.decimals(min_value=3.11, max_value=3.36, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=2.45, max_value=2.93, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=1.66, max_value=1.82, places=1, allow_nan=False, allow_infinity=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([5.6, 5.9, 6.0, 6.1, 6.2, 6.3, 6.7, 6.9, 7.2, 7.9]),
           st.decimals(min_value=2.88, max_value=3.1, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=2.45, max_value=2.93, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=1.66, max_value=1.82, places=1, allow_nan=False, allow_infinity=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.decimals(min_value=6.16, max_value=6.5, places=1, allow_nan=False, allow_infinity=False),
           st.sampled_from([2.2, 2.5, 2.6, 2.8, 2.9, 3.1, 3.2, 3.3, 3.4, 3.8]),
           st.decimals(min_value=4.96, max_value=5.34, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=1.34, max_value=1.65, places=1, allow_nan=False, allow_infinity=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.decimals(min_value=5.78, max_value=6.15, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=2.46, max_value=2.84, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=4.96, max_value=5.34, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=1.34, max_value=1.65, places=1, allow_nan=False, allow_infinity=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.decimals(min_value=5.78, max_value=6.15, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=2.37, max_value=2.45, places=2, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=4.96, max_value=5.34, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=1.34, max_value=1.65, places=1, allow_nan=False, allow_infinity=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([4.9, 5.0, 5.2, 5.4, 5.6, 6.2, 6.4, 6.8, 6.9, 7.0]),
           ...
           st.decimals(min_value=2.45, max_value=2.95, places=1, allow_nan=False, allow_infinity=False),
           st.decimals(min_value=1.34, max_value=1.65, places=1, allow_nan=False, allow_infinity=False))
    @settings(phases=[Phase.generate], max_examples=100)
    ...
    @given(st.sampled_from([4.3, 4.4, 4.5, 4.6, 4.7, 4.9, 5.0, 5.3, 5.5, 5.7]),
           ...
           st.decimals(min_value=2.16, max_value=2.44, places=1, allow_nan=False, allow_infinity=False),
